...
from numpy import exp, power, logical_and, piecewise, cosh, log10, log
...
class extShock_adi_test(EpModel):
    ...
    def __init__(self):
        ...
        def EpEvo(t,eta,j,Gamma0,q):
            ...
            Gamma = norm*power((X-t0)/tn,phi)*power( cosh(log10((X-t0)/breakTime)/delta)/cosh(log10(tn/breakTime)/delta),eps*delta*log(10.)  )
        ...
        self.modName = "extShock_adi_test"
        self.model=EpEvo
